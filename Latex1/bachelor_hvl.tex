...
\begin{document} % Dokument start
	...
	\input{Tekst/Kapittel1 - Innleiing/problemstillings.tex}
	\input{Tekst/Kapittel1 - Innleiing/Analyse av problemet.tex}
	\input{Tekst/Kapittel1 - Innleiing/Vurdering HW-SW.tex}

	% Kapittel 2
	\input{Tekst/Kapittel2/Forrapport.tex}


	% Kapittel 3
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/Anleggets virkemåte.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/VatnetsGangGjennomAnnlegget.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/Mekanisk Utstyr.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/BeskrivelseAvProgram.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/Mottakkstank.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/Reaktor.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/ReaktorSekvensar.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/Slamhandtering.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/Pumpehus.tex}
	\input{Tekst/Kapittel3 - Anleggets virkemåte AKA FSD/Høgbelastningsmodus.tex}
	

	
	% Kapittel 4
	\input{Tekst/Kapittel4 - Programering/Programering.tex}
	\input{Tekst/Kapittel4 - Programering/Utfordringer.tex}
	\input{Tekst/Kapittel4 - Programering/Github.tex}
	\input{Tekst/Kapittel4 - Programering/leVolume.tex}
	

	% Kapittel 5
	\input{Tekst/Kapittel5 - Dokumentasjon/Kap5.tex}
	\input{Tekst/Kapittel5 - Dokumentasjon/Verkemåte.tex}	
	\input{Tekst/Kapittel5 - Dokumentasjon/Interlock.tex}
	\input{Tekst/Kapittel5 - Dokumentasjon/IO-liste.tex}
	\input{Tekst/Kapittel5 - Dokumentasjon/objektliste.tex}
	\input{Tekst/Kapittel5 - Dokumentasjon/Alarmliste.tex}
	\input{Tekst/Kapittel5 - Dokumentasjon/PID.tex}
	\input{Tekst/Kapittel5 - Dokumentasjon/SCD-diagram.tex}

	% I henhold til forrapporten skal vi og ha elektriske teikningar, brukarrettleiing og vedlikehaldsmanual
	
	% Kapittel 6
	\input{Tekst/Kapittel6 - Testing/Testing.tex}

	% Kapittel 7
	\input{Tekst/Kapittel7 - Avslutting-Samandrag-Konklusjon/Avslutting.tex}
	\input{Tekst/Kapittel7 - Avslutting-Samandrag-Konklusjon/Konklusjon.tex}
	\input{Tekst/Kapittel7 - Avslutting-Samandrag-Konklusjon/ExitPoints.tex}
