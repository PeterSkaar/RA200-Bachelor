...
\begin{document} % Dokument start
	...
	\input{Tekst/Kapittel1 - Innleiing/1.0 - Innleiing.tex}
	\input{Tekst/Kapittel1 - Innleiing/1.1 - Innleiing.tex}
	\input{Tekst/Kapittel1 - Innleiing/1.2 - Oppdragsgivar.tex}

	% Kapittel 2 Analyse av problemet
	\input{Tekst/Kapittel2 - Analyse av problemet/2.0 - Analyse av problemet.tex}
	\input{Tekst/Kapittel2 - Analyse av problemet/2.1 - Problemstillings.tex}
	...
	\input{Tekst/Kapittel3 - Krav og mål/3.0 - Krav og mål.tex}

	% Kapittel4 - Anleggets Verkemåte
	\input{Tekst/Kapittel4 - Anleggets Verkemåte/4.0 - Anleggets Virkemåte.tex}
	\input{Tekst/Kapittel4 - Anleggets Verkemåte/4.1 - Generell Virkemåte.tex}
	\input{Tekst/Kapittel4 - Anleggets Verkemåte/4.2 - Teknologisk Virkemåte.tex}
	\input{Tekst/Kapittel4 - Anleggets Verkemåte/4.3 - Teoretisk Virkemåte.tex}
	\input{Tekst/Kapittel4 - Anleggets Verkemåte/4.4 - Praktisk Virkemåte.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/Anleggets virkemåte.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/VatnetsGangGjennomAnnlegget.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/Mekanisk Utstyr.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/BeskrivelseAvProgram.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/Mottakkstank.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/Reaktor.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/ReaktorSekvensar.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/Slamhandtering.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/Pumpehus.tex}
	%\input{Tekst/Kapittel4 - Anleggets Verkemåte/Høgbelastningsmodus.tex}
	
	% Kapittel 5 - Tilrettelegging for programmering
	\input{Tekst/Kapittel5 - Tillrettelegging for programmering/5.0 - Intro.tex}
	\input{Tekst/Kapittel5 - Tillrettelegging for programmering/5.1 - Codesys.tex}
	\input{Tekst/Kapittel5 - Tillrettelegging for programmering/5.2 - IEC.tex}
	\input{Tekst/Kapittel5 - Tillrettelegging for programmering/5.3 - Tiltenkt tilstandsmaskin copy.tex}
	\input{Tekst/Kapittel5 - Tillrettelegging for programmering/5.4 - SCD.tex}

	% Kapittel 6 - Programmering
	\input{Tekst/Kapittel6 - Programmering/6.0 - Programmering.tex}
	\input{Tekst/Kapittel6 - Programmering/Programering.tex}
	\input{Tekst/Kapittel6 - Programmering/Utfordringer.tex}	
	\input{Tekst/Kapittel6 - Programmering/leVolume.tex}
	

	% Kapittel 7 Dokumentasjon
	\input{Tekst/Kapittel7 - Dokumentasjon/7.0 - Intro.tex}
	\input{Tekst/Kapittel7 - Dokumentasjon/Verkemåte.tex}	
	\input{Tekst/Kapittel7 - Dokumentasjon/Interlock.tex}
	\input{Tekst/Kapittel7 - Dokumentasjon/IO-liste.tex}
	\input{Tekst/Kapittel7 - Dokumentasjon/objektliste.tex}
	\input{Tekst/Kapittel7 - Dokumentasjon/Alarmliste.tex}
	\input{Tekst/Kapittel7 - Dokumentasjon/PID.tex}
	\input{Tekst/Kapittel7 - Dokumentasjon/SCD-diagram.tex}

	% Kapittel 8 Simulering og verifisering
	\input{Tekst/Kapittel8 - Simulering-Verifisering/8.0 Simulering og verifisering.tex}
	\input{Tekst/Kapittel8 - Simulering-Verifisering/8.1 - Kontinuerleg Simulering.tex}

	
	% Kapittel 9 Diskusjon
	\input{Tekst/Kapittel9 - Diskusjon/9.0 Diskusjon.tex}
	\input{Tekst/Kapittel9 - Diskusjon/9.1 Vegen vidare for Annlegget.tex}
	...
	\input{Tekst/Kapittel10 - Konklusjon/10.0 Konklusjon.tex}
	\input{Tekst/Kapittel10 - Konklusjon/Avslutting.tex}
	\input{Tekst/Kapittel10 - Konklusjon/Konklusjon.tex}
	\input{Tekst/Kapittel10 - Konklusjon/ExitPoints.tex}
