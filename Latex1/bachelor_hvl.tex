...
\begin{document} % Dokument start
	...
	\input{Tekst/Kapittel4 - Anleggets Verkemåte/4.1 - Teknologisk Virkemåte.tex}
	\input{Tekst/Kapittel4 - Anleggets Verkemåte/4.2 - Teoretisk Virkemåte.tex}
	\input{Tekst/Kapittel4 - Anleggets Verkemåte/4.3 - Praktisk Virkemåte.tex}
	...
	\input{Tekst/Kapittel5 - Tillrettelegging for programmering/5.2 - Github.tex}
