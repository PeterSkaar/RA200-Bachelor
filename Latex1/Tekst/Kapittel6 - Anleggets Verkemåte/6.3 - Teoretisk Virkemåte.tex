...
er ein ``HUBER ROTAMAT Ro9''. Den fungerer som ein liten tank og ein intern nivågivar startar
skruen ved innkommande avlaupsvatn. Skruen tek med uorganisk materiale og fjernar det til eigen avfallshandtering.
Dersom grovrista er ute av drift vil vatnet renne vidare til mottakstanken via eit overløpsrøyr.
...
Frå grovrista renn vatnet med sjølvfall mot mottakstanken som ligg som lågaste punkt på anlegget.
...
for mikroorganismane i reaktoren som vidare gir betre reinsing.
...
På reiseanlegget er det tilleggskrav for fjerning av fosfor \citep{Regjeriga}. På grunn av desse tilleggskrava
er det satt inn eit tertiærreinse steg ved hjelp av simultanfelling.
