...
\begin{figure}[htbp]
    ...
    \caption{RA200 flytskjema}\label{fig:SandeVerkemaate}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Bilete Huber grovrist}\label{fig:HuberGrovrist}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Illustrasjon reaktorsoner}\label{fig:Reaktorsonar}
\end{figure}
