...
\begin{enumerate}
    ...
    \item \textbf{\makebox[3cm][l]{Innpumping}:} Reaktor mottar avlaupsvatn, normalt ifrå ein utjamningstank.
    ...
    \item \textbf{\makebox[3cm][l]{Uttapping}:} Reaktor drenerar reinsavatn mot resepient.
\end{enumerate}
