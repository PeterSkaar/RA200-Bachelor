...
\gsl{SBR} står for 'Sequence Batch Reactor', på norsk 'sekvensiell batchreaktor'.\newline
\gsl{SBR} er en reinsemetode der alle prosessar føregår i same reaktortank. 
...
\begin{figure}[htbp]
    ...
    \caption{\gsl{SBR}-prossessen}\label{fig:HMI}
\end{figure}
...
Meir detaljert informasjon om \gsl{SBR} og anleggets teknolgiske prinsipp er tilgjengeleg i anleggets
