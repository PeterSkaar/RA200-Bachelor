...
\includepdf[pages=1, scale=0.75, pagecommand={\section{Objektliste}\thispagestyle{empty}}]{Appendix/IOliste.pdf}
\includepdf[pages=2, scale=0.75, pagecommand={\section{Objektliste}\thispagestyle{empty}}]{Appendix/IOliste.pdf}
