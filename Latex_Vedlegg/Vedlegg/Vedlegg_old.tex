...
\includepdf[pages=1, angle=90, scale=0.78, pagecommand={\chapter{Alarmlister} \section{Alarm liste}\thispagestyle{fancy}}, fitpaper=true ]{Vedlegg/AlarmLister/AlarmListe.pdf}
