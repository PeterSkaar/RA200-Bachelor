...
% Blåser
\includepdf[pages=1, scale=0.75, pagecommand={\chapter{Manualer}\section{Blåser}\thispagestyle{fancy}}, fitpaper=true ]{Vedlegg/Komponentvedlegg/Blåser/Cat_Blowers_S20_03D08C.pdf}
...
%Motor
\includepdf[pages=1,scale=0.8, pagecommand={\section{Motor}\thispagestyle{fancy}},fitpaper=true]{Vedlegg/Komponentvedlegg/Motor/p-7101-bgm.pdf}
...
%Transmitter
\includepdf[pages=1,scale=0.8, pagecommand={\section{Transmitter Expert}\thispagestyle{fancy}},fitpaper=true]{Vedlegg/Komponentvedlegg/Transmitter/Hydrostatisk Pressure/Expert.pdf}
...
\includepdf[pages=1,scale=0.8, pagecommand={\section{Transmitter Vegabar}\thispagestyle{fancy}},fitpaper=true]{Vedlegg/Komponentvedlegg/Transmitter/Hydrostatisk Pressure/Vegabar.pdf}
