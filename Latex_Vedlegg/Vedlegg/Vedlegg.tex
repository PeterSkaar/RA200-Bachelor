...
% Alarmlister
\includepdf[pages=1, scale=0.8, angle=-90, pagecommand={\chapter{Varslingslister} \section{Alarm liste}\thispagestyle{fancy}}, fitpaper=true]{Vedlegg/AlarmLister/AlarmListe.pdf}
...
% PLS
\includepdf[pages=1, scale=0.8, pagecommand={\section{FX-4AD SPECIAL FUNCTION BLOCK}\thispagestyle{fancy}}, fitpaper=true]{Vedlegg/Komponentvedlegg/FX4AD.pdf}
\includepdf[pages=2-, scale=0.8, pagecommand={\thispagestyle{fancy}}, fitpaper=true]{Vedlegg/Komponentvedlegg/FX4AD.pdf}
