...
% Forprosjekt
\includepdf[pages=1, scale=0.8, pagecommand={\chapter{Forprosjekt}\thispagestyle{fancy}\fancyfoot[C]{\thepage}}]{Vedlegg/B024EF-03 - ForprosjektV2}
\includepdf[pages=2-, scale=0.8, pagecommand={\thispagestyle{fancy}\fancyfoot[C]{\thepage}}]{Vedlegg/B024EF-03 - ForprosjektV2}